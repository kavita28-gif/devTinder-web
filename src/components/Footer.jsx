...
const Footer = () => {
  return (
    <footer className="footer bg-base-200 text-neutral-content p-4 fixed bottom-0 justify-between">
      <aside className="grid-flow-col items-center">
        <svg
          ...
          fillRule="evenodd"
          clipRule="evenodd"
          className="fill-current text-[#a097a0]"
        >
       ...
       <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end text-sm">
        <Link to="/cancellation-and-refunds" className="text-[#a097a0]" >Cancellation & Refunds</Link>
